export default {
  ...
  faqs: [
    {
      question: '维多利亚有哪些类型的小学？',
      answer: [
        '维多利亚有几种类型的小学：',
        '• 公立学校：免费对所有人开放，大多数学生就读于本地的指定邻里学校。',
        '• 天主教学校：信仰学校，通常与当地教堂相关联。费用低于私立学校。',
        '• 私立学校：设有自己的规定、费用和课程安排。一些是信仰学校，一些则注重学术或特色教育。',
        '您可以选择任何类型的学校，但某些学校（特别是公立学校）是否有名额取决于您住的区域。'
      ]
    },
    {
      question: '什么是学区，我如何找到我所在的学区学校？',
      answer: [
        '学区是围绕学校划定的地理区域，决定哪些学生有优先入学权。',
        '每所维多利亚公立学校都有自己的学区，学区内的学生有权就读该校。',
        '您可以使用官方“Find My School”工具或我们的网站来查看您家的学区并了解可入读的学校。'
      ]
    },
    {
      question: '我如何为孩子报名入学？',
      answer: [
        '请直接联系学校索取入学表，或从教育厅网站下载。',
        '您需要填写表格并提供地址证明、身份证件和疫苗接种记录等材料。'
      ]
    },
    {
      question: '我可以同时为孩子申请多所学校吗？',
      answer: [
        '不可以。虽然您可以申请多所学校，但孩子只能注册其中一所。',
        '一旦被确认录取，其他学校的录取应当被拒绝。'
      ]
    }
  ]
},
    ...
    frequentAsk: {
        faqs: [
            {
                question: '维多利亚州有哪些类型的小学？',
                answer: [
                    '维多利亚州有几种类型的小学：',
                    '• 公立学校：免费就读，面向所有人开放。大多数学生就读于当地的指定社区学校。',
                    '• 天主教学校：基于信仰的学校，通常与当地教堂有关联。家庭通常需要支付学费，但低于私立学校。',
                    '• 独立（私立）学校：这些学校自行制定规则、收费和课程。有些是基于信仰的，其他则是学术或专业学校。',
                    '您可以选择任何类型的学校，但某些学校（特别是公立学校）的学位取决于您的居住地址。'
                ]
            },
            {
                question: '什么是学区，如何查找我所在学区的学校？',
                answer: [
                    '学区是指学校周围的地理区域，确定哪些学生有保证的入学权利。',
                    '维多利亚州的每所公立学校都有学区，居住在该学区的儿童有权就读该学校。',
                    '您可以使用官方的“查找我的学校”工具或我们的网站来查看您家的学区以及可选择的学校。'
                ]
            },
            {
                question: '如何为我的孩子报名上学？',
                answer: [
                    '直接联系学校索取入学申请表，或从教育部网站下载。',
                    '您需要填写表格并提供地址证明、身份证件和免疫记录等文件。'
                ]
            },
            {
                question: '我可以同时为孩子申请多所学校吗？',
                answer: [
                    '不可以。虽然您可以申请多所学校，但您的孩子一次只能在一所学校就读。',
                    '一旦接受并确认入学，应拒绝其他录取通知。'
                ]
            }
        ]
