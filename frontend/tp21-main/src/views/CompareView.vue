<template>
  ...
  <div v-if="schools[i - 1].languageProgramArr.length" class="flex flex-wrap gap-4 mt-6 justify-center min-h-[80px]">
    ...
    <span
      ...
      :key="j"
      class="bg-blue-600 text-white px-4 py-2 rounded-full w-1/3 text-center truncate"
      :class="{
        'text-xl': lang.length <= 7,
        'text-lg': lang.length > 7,
        'text-base': lang.length >= 15,
  ...
  <!-- Display "None" -->
  <div v-else class="text-500 w-full text-center py-2 min-h-[80px] mt-6">
    None
  </div>
  ...
  <div class="flex items-center justify-between group">
    ...
    <div class="relative">
      ...
      <svg width="28" height="30" viewBox="0 0 28 30" fill="none" xmlns="http://www.w3.org/2000/svg"  class="w-16 h-16 text-gray-600 cursor-pointer">
