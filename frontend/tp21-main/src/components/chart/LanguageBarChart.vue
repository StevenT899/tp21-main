...
const chartOptions = computed(() => {
  ...
  if (props.notStated > 0) {
    series.push({
      name: t('chart.languages.notStated'),
      type: 'bar',
      stack: 'total',
    ...
    legendData.push(t('chart.languages.notStated'));
  }

  // Include 'English' if value > 0
  if (props.english > 0) {
    series.push({
      name: t('chart.languages.english'),
      type: 'bar',
      stack: 'total',
      data: [props.english],
      label: {
    ...
    legendData.push(t('chart.languages.english'));
  }

  // Include 'Other Languages' if value > 0
  if (props.notEnglish > 0) {
    series.push({
      name: t('chart.languages.otherLanguages'),
      type: 'bar',
      stack: 'total',
    ...
    legendData.push(t('chart.languages.otherLanguages'));
  }
